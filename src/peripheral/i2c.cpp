...
int I2c::read(uint16_t addr, uint8_t* data, size_t len) { return i2c_read(dev_, data, len, addr); }

int I2c::write_read(uint16_t addr, const uint8_t* tx, size_t tx_len, uint8_t* rx, size_t rx_len) {
